package com.galaxy.commons.lock.aspect;

import com.galaxy.commons.lock.DistributedLock;
import com.galaxy.commons.lock.annotation.CustomerLock;
import com.galaxy.commons.lock.extension.ExtensionLoader;
import com.galaxy.commons.result.AbstractOpenApiRequest;
...
public class DistributedLockAspect {
    ...
    @Pointcut("@annotation(com.galaxy.commons.lock.annotation.CustomerLock)")
    ...
    private String parseKey(String key, Method method, Object[] args) {
        ...
        Object obj = parser.parseExpression(key).getValue(context);

        if(obj instanceof AbstractOpenApiRequest){
            String reqId=((AbstractOpenApiRequest) obj).getReqId();
            logger.info("AbstractOpenApiRequest ReqId is [" +  reqId + "]");
            return reqId;
